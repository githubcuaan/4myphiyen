...
var settings = {
  particles: {
    length: 500, // số lượng tối đa của hạt
    duration: 2, // thời gian tồn tại của hạt (giây)
    velocity: 100, // tốc độ di chuyển (px/giây)
    effect: -0.75, // ảnh hưởng của gia tốc
    size: 30, // kích thước của hạt
  },
};

// lớp point dùng biểu diễn vị trí, vận tốc, gia tốc của các hạt
var Point = (function () {
  function Point(x, y) {
    this.x = x || 0;
    this.y = y || 0;
...
// đại diện cho từng chuyển động của hạt trên canvas
...
(function (canvas) {
  ...
  function render() {
    ...
    context.fillText("alo alo", canvas.width / 2, textPosition.y); // Dòng chữ
  }
